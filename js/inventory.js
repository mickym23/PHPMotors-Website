...
function buildInventoryList(data) { 
   ...
   data.forEach(function (element) { 
    ...
    dataTable += `<tr class='vTableRow'><td class='vTableData'>${element.invMake} ${element.invModel}</td>`; 
    dataTable += `<td class='vTableData vControls'><a href='/phpmotors/vehicles?action=mod&invId=${element.invId}' title='Click to modify'>Modify</a></td>`; 
    dataTable += `<td class='vTableData vControls'><a href='/phpmotors/vehicles?action=del&invId=${element.invId}' title='Click to delete'>Delete</a></td></tr>`; 
   }) 
   dataTable += '</tbody>'; 
